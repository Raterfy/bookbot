...
BookBot is a simple Python project that reads the text of "Frankenstein" from a file, counts the words and characters, and generates a report.

## Exemple of report
```bash
--- Begin report of books/frankenstein.txt ---
77986 are found in Frankenstein.txt
